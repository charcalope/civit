...
urlpatterns = [
    ...
    path('dashboardpanel/', views.dashboardpanel, name='dashboardpanel'),
    path('<pk>/expensepanel', views.expenses_panel, name='expensepanel'),
    path('<pk>/expenserecords', views.expenserecords, name='expenserecords'),
    ...
    path('<pk>/vieworganizers', views.vieworganizers, name='vieworganizers'),
    path('<pk>/addorganizers', views.addorganizers, name='addorganizers'),
